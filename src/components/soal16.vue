<template>
      ...
      <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden mt-20">
        <div class="p-8 space-y-6">
          <h1 class="text-3xl font-bold text-gray-900 mb-6">
            Data 16: Bekerja Pada Bidang Floristry
          </h1>
  
          <form @submit.prevent="submitAnswer" class="space-y-4">
            <div class="flex flex-col space-y-4">
              <div v-for="(field, index) in certificateFields" :key="index">
                <hr v-if="['owner_berbadan_hukum', 'owner_tanpa_badan_hukum', 'freelance_designer'].includes(field.key)" 
  ...
  const certificateFields = [
    { key: 'aktif_merangkai', label: 'a. Aktif merangkai bunga di florist (staff/owner) (10 poin)' },
    { key: 'owner_berbadan_hukum', label: 'b. Owner florist yang mempunyai badan hukum (10 poin)' },
    { key: 'owner_tanpa_badan_hukum', label: 'c. Owner florist yang tidak berbadan hukum (5 poin)' },
    { key: 'freelance_designer', label: 'd. Freelance Designer (5 poin)' }
  ];
  ...
  <style scoped>
  /* Gunakan style yang sama dari soal15.vue */
  .min-h-screen {
