<template>
      ...
      <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden mt-20">
        <div class="p-8 space-y-6">
          <h1 class="text-3xl font-bold text-gray-900 mb-6">
            Soal 14: Kemampuan Mengajar Secara Online
          </h1>
          ...
          <form @submit.prevent="submitAnswer" class="space-y-4">
            <div class="flex flex-col space-y-4">
              <div class="flex flex-col gap-2 p-2">
                ...
                <select v-model="selectedNgajar" class="border p-2 rounded-md w-2/3 form-radio">
  ...
  const deleteData = async () => {
    try {
      ...
      console.error('Failed to delete data:', error.response ? error.response.data : error.message);
    }
  };
  </script>
  
  <style scoped>
  /* Gunakan style yang sama dari soal12.vue */
  .min-h-screen {
