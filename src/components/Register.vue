...
async function requestOtp() {
  try {
    const response = await axios.post("https://f9b5-103-149-116-67.ngrok-free.app/api/otp/send", {
...
async function verifyOtp() {
  try {
    const response = await axios.post("https://f9b5-103-149-116-67.ngrok-free.app/api/otp/verify", {
      nomor: nomor.value, // Kirim nomor yang benar
...
async function registerAccount() {
  try {
    const response = await axios.post("https://f9b5-103-149-116-67.ngrok-free.app/api/users", {
      name: nama.value,
      nomor: nomor.value, // Kirim nomor yang benar
      email: email.value,
