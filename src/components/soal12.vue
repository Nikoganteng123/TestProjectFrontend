<template>
          ...
          <form @submit.prevent="submitAnswer" class="space-y-4">
            <div class="flex flex-col space-y-4">
              <div class="flex flex-col gap-2 p-2">
                ...
                <select v-model="selectedJabatan" class="border p-2 rounded-md w-2/3 form-radio">
  ...
  <style scoped>
  /* Gunakan style yang sama dari soal2.vue */
  .min-h-screen {
  ...
  .form-radio {
    ...
    appearance: auto; /* Override untuk select */
  }
